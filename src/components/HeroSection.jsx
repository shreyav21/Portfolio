      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg lg:text-xl mb-6">
            Crafting intuitive, user-friendly interfaces that bring ideas to
            life. Passionate about building seamless web experiences with modern
            technologies.
          </p>

          {/* Button Section */}
          <div className="mb-6 flex flex-col sm:flex-row sm:space-x-4 sm:space-y-0 space-y-4">
            {/* Hire Me Button */}
            ...
            {/* My Resume Button */}
            <a
              href="https://drive.google.com/file/d/1ochqtzx2pienSgmqYj7eRui2aezDNrSS/view?usp=drive_link"
              target="_blank"
              rel="noopener noreferrer"
            >
              <button className="px-6 py-3 rounded-full w-full sm:w-auto bg-transparent hover:bg-slate-800 text-white border border-white">
                My Resume
              </button>
            </a>
          </div>
          ...
          <div className="flex space-x-4">
            <a
              href="https://www.linkedin.com/in/shreya-vedpathak-40894422b/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://github.com/shreyav21"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:opacity-80"
            >
